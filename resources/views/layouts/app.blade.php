    ...
    <aside class="hidden lg:flex min-h-screen flex-col border-r border-zinc-200 bg-[#f7f7f6]">
        <div class="border-b border-zinc-200 p-6">
            <div class="museum-brand-lockup">
                @if($brandLogoUrl)
                    <img src="{{ $brandLogoUrl }}" alt="logo" class="museum-brand-logo">
                @endif
        ...
        <nav class="flex-1 space-y-1 p-4 text-sm">
            ...
            <a href="{{ route('locations.index', [], false) }}" class="museum-nav-item flex items-center gap-3 {{ request()->routeIs('locations.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('artists.index', [], false) }}" class="museum-nav-item flex items-center gap-3 {{ request()->routeIs('artists.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('settings.index', [], false) }}" class="museum-nav-item flex items-center gap-3 {{ request()->routeIs('settings.*') ? 'active' : '' }}">
            ...
            @if(auth()->check() && auth()->user()->isAdmin())
                ...
                <a href="{{ route('admin.users.index', [], false) }}" class="museum-nav-item flex items-center gap-3 {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.activity-logs.index', [], false) }}" class="museum-nav-item flex items-center gap-3 {{ request()->routeIs('admin.activity-logs.*') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.docs.technical', [], false) }}" class="museum-nav-item flex items-center gap-3 {{ request()->routeIs('admin.docs.technical') ? 'active' : '' }}">
        ...
        <div class="mx-auto w-full max-w-350 p-6 lg:p-10">
            ...
            @auth
                ...
                <div class="mb-6 flex items-center justify-end gap-3">
                    ...
                    <a href="{{ route('profile.edit', [], false) }}" class="museum-btn-secondary inline-flex items-center gap-2">
...
<div id="mobileMenu" class="mobile-nav" aria-hidden="true">
    <div class="mobile-nav-panel" role="dialog" aria-modal="true" aria-label="Navigation menu">
        ...
        @if(auth()->check() && auth()->user()->isAdmin())
            ...
            <a href="{{ route('admin.activity-logs.index', [], false) }}" class="mobile-nav-link {{ request()->routeIs('admin.activity-logs.*') ? 'active' : '' }}">Activity Logs</a>
            <a href="{{ route('admin.docs.technical', [], false) }}" class="mobile-nav-link {{ request()->routeIs('admin.docs.technical') ? 'active' : '' }}">Technical Docs</a>
        @endif
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        notificationDetails?.addEventListener('toggle', () => {
            ...
            fetch("{{ route('notifications.mark-read', [], false) }}", {
                method: 'POST',
                headers: {
