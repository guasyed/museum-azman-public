...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="<?php echo e(asset('favicon.svg')); ?>?v=2">
    <link rel="alternate icon" href="<?php echo e(asset('favicon.ico')); ?>?v=2">
...
<?php /**PATH /home/museumaz/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>