...
<?php $component->withAttributes(['title' => 'Dashboard - Museum Azman']); ?>
        ...
        <div class="grid gap-3 xl:grid-cols-[1.05fr_1fr]">
            ...
            <div id="geo-distribution-chart" class="dashboard-geo-chart mx-auto mt-4 mb-4 w-full max-w-95"></div>
                ...
                <div class="mt-6 grid grid-cols-3 border-t border-zinc-200 pt-5 text-center">
                    <div><p class="museum-stat-value"><?php echo e($geo['malaysia']); ?></p><p class="text-sm text-zinc-600">Malaysia</p></div>
                    <div><p class="museum-stat-value"><?php echo e($geo['southeast_asia']); ?></p><p class="text-sm text-zinc-600">Southeast Asia</p></div>
                    <div><p class="museum-stat-value"><?php echo e($geo['rest_of_world']); ?></p><p class="text-sm text-zinc-600">Rest of World</p></div>
                </div>
            </article>
    ...
    <script>
        const renderGeoDistributionChart = () => {
            ...
            const geoSeriesData = [
                { name: 'Malaysia', y: <?php echo e((int) ($geo['malaysia'] ?? 0)); ?> },
                { name: 'Southeast Asia', y: <?php echo e((int) ($geo['southeast_asia'] ?? 0)); ?> },
                { name: 'Rest of World', y: <?php echo e((int) ($geo['rest_of_world'] ?? 0)); ?> },
            ];
