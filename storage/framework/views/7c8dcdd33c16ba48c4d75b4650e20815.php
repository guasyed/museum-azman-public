...
<?php $component->withAttributes(['title' => 'Movement Tracker - Museum Azman']); ?>
    <section class="space-y-6">
        ...
        <article class="museum-panel p-5">
                    ...
                    <div class="rounded-xl border border-zinc-200 bg-white p-4">
                        ...
                        <div class="grid gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <p><?php echo e(\App\Support\DateFormat::display($movement->date_out)); ?></p>
                            ...
                            <div>
                                ...
                                <p><?php echo e(\App\Support\DateFormat::display($movement->expected_return_date)); ?></p>
            ...
            <?php if($activeMovements->hasPages()): ?>
                <div class="mt-5">
                    <?php echo e($activeMovements->links()); ?>
                ...
                <table class="w-full min-w-[980px] text-sm">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $movements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="border-b border-zinc-100 align-top">
                            ...
                            <td class="py-3"><?php echo e(\App\Support\DateFormat::display($movement->date_out)); ?></td>
                            <td class="py-3"><?php echo e(\App\Support\DateFormat::display($movement->expected_return_date)); ?></td>
