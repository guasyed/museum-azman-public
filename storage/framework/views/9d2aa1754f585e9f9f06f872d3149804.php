                                    ...
                                    <div class="inline-flex items-center gap-2">
                                        ...
                                        <?php if(auth()->check() && auth()->user()->isAdmin()): ?>
                                            <button
                                                ...
                                                data-artist-country="<?php echo e($artist->country); ?>"
                                                data-artist-birth="<?php echo e($artist->birth_year); ?>"
                                                data-artist-bio="<?php echo e($artist->biography); ?>"
                                                aria-label="Edit <?php echo e($artist->name); ?>"
                                            >
        ...
        <div class="museum-modal" role="dialog" aria-modal="true" aria-labelledby="artist-form-title" style="max-width:36rem;">
            ...
            <form id="artist-form" method="POST" class="space-y-4">
                ...
                <label class="museum-field block">
                    ...
                    <input type="number" name="birth_year" id="af-birth" min="1000" max="<?php echo e(date('Y')); ?>" placeholder="e.g. 1975">
                </label>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const createRoute    = <?php echo json_encode(route('artists.store'), 15, 512) ?>;
    const updateRouteBase= <?php echo json_encode(route('artists.update', ['artist' => '__ID__']), 512) ?>;
    const deleteRouteBase= <?php echo json_encode(route('artists.destroy', ['artist' => '__ID__']), 512) ?>;
