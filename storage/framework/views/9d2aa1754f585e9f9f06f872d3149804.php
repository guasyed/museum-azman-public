    ...
    <section class="space-y-6">
        ...
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center">
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('artists.index', array_merge(request()->query(), ['sort' => 'value']))); ?>" class="museum-btn-secondary <?php echo e($sort === 'value' ? 'bg-zinc-900 text-white! border-zinc-900 hover:bg-zinc-800' : ''); ?>">Sort by Value</a>
                <a href="<?php echo e(route('artists.index', array_merge(request()->query(), ['sort' => 'works']))); ?>" class="museum-btn-secondary <?php echo e($sort === 'works' ? 'bg-zinc-900 text-white! border-zinc-900 hover:bg-zinc-800' : ''); ?>">Sort by Works</a>
                <a href="<?php echo e(route('artists.index', array_merge(request()->query(), ['sort' => 'name']))); ?>" class="museum-btn-secondary <?php echo e($sort === 'name' ? 'bg-zinc-900 text-white! border-zinc-900 hover:bg-zinc-800' : ''); ?>">Sort by Name</a>
