                        ...
                        <tbody id="artwork-results-table-body">
                            <?php $__empty_1 = true; $__currentLoopData = $artworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artwork): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr id="artwork-<?php echo e($artwork->id); ?>" class="border-b border-zinc-200 last:border-b-0">
                                    ...
                                    <td class="px-4 py-3.5 text-zinc-600"><?php echo e($artwork->medium ?: '-'); ?></td>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr><td colspan="<?php echo e($canManageArtworks ? 7 : 6); ?>" class="px-4 py-5 text-zinc-500">No artworks found for this filter.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
                    ...
                    <article id="artwork-<?php echo e($artwork->id); ?>" class="overflow-hidden rounded-2xl border border-zinc-300 bg-white">
                        <a href="<?php echo e(route('artworks.show', ['artwork' => $artwork, 'from' => 'collection', 'return' => request()->fullUrlWithQuery(['scroll_to' => $artwork->id])])); ?>">
                            <?php if($artwork->primary_image_url): ?>
                                <img src="<?php echo e($artwork->primary_image_url); ?>" alt="<?php echo e($artwork->title); ?>" class="h-95 w-full object-cover">
                            <?php else: ?>
