...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Collection - Museum Azman']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Collection - Museum Azman']); ?>
    <style>
            ...
            <div class="flex flex-col gap-3 xl:flex-row xl:items-center">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    <select name="region" class="min-w-46 rounded-xl border border-zinc-300 bg-white px-4 py-2.5">
                        ...
                        <?php $__currentLoopData = $regionOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($region); ?>" <?php if($selectedRegion === $region): echo 'selected'; endif; ?>><?php echo e($region); ?></option>
                        ...
                        <tbody id="artwork-results-table-body">
                            <?php $__empty_1 = true; $__currentLoopData = $artworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artwork): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr id="artwork-<?php echo e($artwork->id); ?>" class="border-b border-zinc-200 last:border-b-0">
                                    <td class="px-4 py-3.5 font-mono text-xs font-semibold text-zinc-500"><?php echo e($artwork->display_inventory_code); ?></td>
                                    ...
                                    <td class="px-4 py-3.5 text-zinc-600"><?php echo e($displayMedium); ?></td>
                                    <td class="px-4 py-3.5 text-right font-semibold"><?php echo e(\App\Support\Currency::short((float) $artwork->current_valuation)); ?></td>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr><td colspan="<?php echo e($canManageArtworks ? 8 : 7); ?>" class="px-4 py-5 text-zinc-500">No artworks found for this filter.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
            ...
            <div id="artwork-results-list" class="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                <?php $__empty_1 = true; $__currentLoopData = $artworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artwork): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <article id="artwork-<?php echo e($artwork->id); ?>" class="overflow-hidden rounded-2xl border border-zinc-300 bg-white">
                        ...
                        <div class="p-4">
                            <p class="mb-2 font-mono text-xs font-semibold uppercase tracking-wide text-zinc-500"><?php echo e($artwork->display_inventory_code); ?></p>
                            ...
                            <div class="mt-3 space-y-1 text-sm text-zinc-600">
                                <p><?php echo e($displayMedium); ?></p>
                                <p><?php echo e($sizeText); ?></p>
                            </div>
                        </div>

                        <div class="flex items-center justify-between border-t border-zinc-200 px-4 py-2.5">
                            <!--<p class="font-semibold text-zinc-800"><?php echo e(\App\Support\Currency::short((float) $artwork->current_valuation)); ?></p>-->
                            <div class="flex items-center gap-2">
                                <span class="inline-flex rounded-lg px-2.5 py-1 text-xs font-semibold <?php echo e($statusClass); ?>"><?php echo e($artwork->status ?: 'Unknown'); ?></span>
                                <?php if($canManageArtworks): ?>
                                    <a
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const currentView = <?php echo json_encode($view, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH /Users/syed/MEGA/WORK/RELIVA/Website/LEBTECH/museum-azman/resources/views/artworks/index.blade.php ENDPATH**/ ?>