...
<div id="mobileMenu" class="mobile-nav" aria-hidden="true">
    <div class="mobile-nav-panel" role="dialog" aria-modal="true" aria-label="Navigation menu">
        ...
        <?php if(auth()->guard()->check()): ?>
            ...
            <form method="POST" action="<?php echo e(route('logout', [], false)); ?>" class="mt-2">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/syed/MEGA/WORK/RELIVA/Website/LEBTECH/museum-azman/resources/views/layouts/app.blade.php ENDPATH**/ ?>